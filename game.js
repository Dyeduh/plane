class Main extends Phaser.Scene {
    ...
    preload() {
        this.load.spritesheet('plane', 'plane/planesheet.png', {frameWidth: 98, frameHeight: 83});
        this.load.image('pipe', 'plane/pipe.png');
        this.load.audio('jumpSound', 'plane/jump.wav');
    }
